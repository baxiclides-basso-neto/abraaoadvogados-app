      ...
      <BottomSection>
        ...
        <QuestionsBox>
          <div onClick={toggleSection1}>
            ...
            {showSection1 && (
              <p>
                Para receber os valores descontados do seu salário maternidade é
                necessário ingressar com um processo judicial. Trata-se de uma
                Ação de Cobrança contra o governo pedindo a restituição dos
                valores descontados.
              </p>
            )}
          </div>
          <div onClick={toggleSection2}>
            ...
            {showSection2 && (
              <p>
                ...
                recebeu diretamente do INSS o desconto é maior, chegando a 20%!
              </p>
            )}
          </div>
          <div onClick={toggleSection3}>
            ...
            {showSection3 && (
              <p>
                ...
                DIREITO ao pagamento! Entre em contato conosco para analisarmos
                o seu caso.
              </p>
            )}
          </div>
        ...
        <LegalDecisionsBox>
          <p>
            ...
            contribuição previdenciária sobre o salário-maternidade, a partir do
            entendimento do Supremo Tribunal Federal, nos termos da Súmula 669,
            condenar a União ao{" "}
            <span> pagamento de R$ 3.000,00 (três mil reais)</span> de
            indenização pelos danos morais sofridos pela parte autora, valor
            este que deve ser atualizado monetariamente desde a data da sentença
            e acrescido de juros moratórios de 1% ao mês, a partir da citação.
            Fonte: TJ-MG, Apelação Cível 1.0000.20.035679-7/002, rel. Des. José
            Flávio de Almeida, 17ª Câmara Cível, j. 11/03/2021.
          </p>
          <p>
            ...
            <span> quantia de R$ 5.000,00 (cinco mil reais),</span> a título de
            danos morais, também corrigida monetariamente a partir desta
          ...
          <p>
            Julgo procedente o pedido formulado na inicial, resolvendo o mérito
            da lide, com fulcro no art. 487, inciso I, do Código de Processo
            Civil, para declarar a inexigibilidade da contribuição
            ...
            corrigida monetariamente a partir do desembolso, acrescida de juros
            de mora, nos termos do Manual de Orientação de Procedimentos para os
            Cálculos na Justiça Federal, a partir da citação. Fonte: JF-PR, Ação
            Ordinária 5000112-73.2020.4.04.7019, rel. Juiz Federal Edson Rodrigo
            de Moraes, 3ª Vara Federal de Londrina, j. 28/01/2021.
          </p>
          <button>
            <div>
              <Image
